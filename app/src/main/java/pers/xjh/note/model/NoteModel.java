...
import pers.xjh.note.ui.detail.android.PathActivity;
...
import pers.xjh.note.ui.detail.android.ServiceLifeCycleActivity;
import pers.xjh.note.ui.detail.android.ShaderActivity;
import pers.xjh.note.ui.detail.android.ShellCommendActivity;
...
import pers.xjh.note.ui.detail.android.StaticIPActivity;
import pers.xjh.note.ui.detail.android.SystemPropertyActivity;
import pers.xjh.note.ui.detail.android.TakePictureActivity;
...
import pers.xjh.note.ui.detail.android.VideoViewNetworkActivity;
        ...
        Observable observable = Observable.create(new ObservableOnSubscribe<List<Note>>() {
            ...
            public void subscribe(ObservableEmitter<List<Note>> e) throws Exception {
                ...
                if(Constant.NOTE_ALL == noteType) {
                    ...
                    noteList.add(new Note("OpenGL", Constant.NOTE_OPENGL, NoteActivity.class));
                    ...
                    noteList.add(new Note("service生命周期", ServiceLifeCycleActivity.class));
                    ...
                    noteList.add(new Note("设置静态ip", StaticIPActivity.class));
                    noteList.add(new Note("执行shell命令", ShellCommendActivity.class));
