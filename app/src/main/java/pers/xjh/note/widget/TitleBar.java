...
public class TitleBar extends FrameLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs != null) {
            ...
            mTitleBackground = ta.getColor(R.styleable.TitleBar_titleBackground, Color.rgb(0, 176, 255));
            mTitle = ta.getString(R.styleable.TitleBar_title);
            mTitleTextSize = ta.getDimension(R.styleable.TitleBar_titleTextSize, 16);
            mTitleTextColor = ta.getColor(R.styleable.TitleBar_titleTextColor, Color.rgb(255, 255, 255));
            mLeftBackground = ta.getResourceId(R.styleable.TitleBar_leftBackground, R.drawable.ic_back_arrow);
            mRightText = ta.getString(R.styleable.TitleBar_rightText);
            mRightTextSize = ta.getDimension(R.styleable.TitleBar_rightTextSize, 12);
            mRightTextColor = ta.getColor(R.styleable.TitleBar_titleTextColor, Color.WHITE);
            ta.recycle();
        }
        init();
    }
    ...
    private void init() {
        ...
        mLeftTitleContainer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                RtEnv.getCurrentActivity().onBackPressed();
            }
        });
    }
