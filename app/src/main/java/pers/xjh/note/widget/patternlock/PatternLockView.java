package pers.xjh.note.widget.patternlock;
...
import pers.xjh.note.widget.patternlock.utils.ResourceUtils;

import static pers.xjh.note.widget.patternlock.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static pers.xjh.note.widget.patternlock.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static pers.xjh.note.widget.patternlock.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static pers.xjh.note.widget.patternlock.PatternLockView.PatternViewMode.AUTO_DRAW;
import static pers.xjh.note.widget.patternlock.PatternLockView.PatternViewMode.CORRECT;
import static pers.xjh.note.widget.patternlock.PatternLockView.PatternViewMode.WRONG;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mWrongStateColor = typedArray.getColor(R.styleable.PatternLockView_wrongStateColor,
                    ResourceUtils.getColor(getContext(), R.color.orangered));
